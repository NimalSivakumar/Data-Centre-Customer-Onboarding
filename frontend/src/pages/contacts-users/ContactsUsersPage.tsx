...
function ContactForm({ companies, selected, onSubmit }: { companies: Company[]; selected: Company | null; onSubmit: (event: FormEvent<HTMLFormElement>) => void }) {
...
function NewUserForm({ companies, selected, onSubmit }: { companies: Company[]; selected: Company | null; onSubmit: (event: FormEvent<HTMLFormElement>) => void }) {
...
function ExistingUserForm({ companies, selected, contacts, onSubmit }: { companies: Company[]; selected: Company | null; contacts: Contact[]; onSubmit: (event: FormEvent<HTMLFormElement>) => void }) {
